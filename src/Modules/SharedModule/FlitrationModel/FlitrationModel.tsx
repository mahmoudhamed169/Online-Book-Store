...
import AccordionModel from "../Components/AccordionModel/AccordionModel";
...
export default function FlitrationModel() {
  const randomImage = () => {
  ...
  const [isGridMode, setIsGridMode] = useState(true); // State for grid mode
    ...
    <div className="p-3">
      <div className="row p-3">
        ...
        <div className="col-md-10 m-auto">
          <div className="row">
            <div className="col-md-4 d-flex align-items-center my-4">
              <p
                className="me-3 mt-1"
            ...
            <div className="col-md-3 d-flex align-items-center">
              <Typography
                variant="body1"
                gutterBottom
                sx={{ color: "#393280", fontWeight: 600, my: 4 }}
              >
            ...
            <div className="col-md-3 d-flex justify-content-center align-items-center my-4">
              {isGridMode ? (
                <ReorderIcon
                  onClick={toggleGridMode}
                  sx={{ mr: 5, color: "#ED553B" }}
                />
              ) : (
                <WindowIcon
                  onClick={toggleGridMode}
          ...
          <div className="container my-3">
            <div
              className={`${isGridMode ? "row" : `${styles.bookItem}`} mt-2`}
            >
              {booksList.map((book, index) => (
                <div
                  key={index}
                  className={`${isGridMode ? "col-md-4" : ""} mt-2`}
                >
